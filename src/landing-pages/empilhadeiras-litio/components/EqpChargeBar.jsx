  ...
  return (
    <section className="bg-eqp-ink-deep border-y border-eqp-seam py-6">
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex items-center gap-4 md:gap-8">
        ...
        <div className="flex-1 relative h-3 rounded-sm border border-eqp-charge/30 bg-eqp-charge/10 overflow-hidden">
          <motion.div
            className="absolute inset-y-0 left-0 bg-eqp-charge"
            initial={{ width: '0%' }}
        ...
        >
          <BatteryCharging className="text-eqp-charge-bright shrink-0" size={26} strokeWidth={1.75} aria-hidden="true" />
        </motion.div>
      </div>
    </section>
  )
