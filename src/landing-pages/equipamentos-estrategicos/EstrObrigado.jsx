...
export default function EstrObrigado() {
  const location = useLocation()
  const equipamento = location.state?.equipamento || ''
  const whatsappHref = buildWhatsappHref(WHATSAPP_TAIS, equipamento)
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Obrigado — Avapex Equipamentos Estratégicos</title>
