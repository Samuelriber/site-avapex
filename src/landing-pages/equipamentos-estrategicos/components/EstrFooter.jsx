...
const solucoes = [
  { href: '#orcamento', label: 'Empilhadeiras Diesel' },
  { href: '#orcamento', label: 'Caminhões e Transporte' },
  { href: '#orcamento', label: 'Locação com Operador' },
]
...
export default function EstrFooter() {
  const whatsappTais = buildWhatsappHref(WHATSAPP_TAIS)
  const whatsappJoice = buildWhatsappHref(WHATSAPP_JOICE)
          ...
          <div className="flex flex-col gap-7 shrink-0 lg:pr-10 lg:border-r border-eqp-seam">
            <div className="flex flex-col items-start gap-4">
              ...
              <p className="text-eqp-fog text-sm max-w-[240px]">
                Especialistas em locação de equipamentos pesados e movimentação de cargas para a indústria nacional.
              </p>
              <a
