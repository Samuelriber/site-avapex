      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div data-aos="fade-right" className="flex flex-col h-full">
            ...
            <div className="rounded-2xl overflow-hidden h-64 border border-slate-700 shadow-lg relative w-full mt-auto flex-grow max-h-[300px]">
              <iframe
          ...
          {/* Right column — form */}
          <div
            className="bg-white text-slate-900 p-8 md:p-10 rounded-3xl shadow-2xl relative"
            data-aos="fade-left"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="form_nome" className="block text-sm font-bold text-slate-700 mb-2">
                    Nome do Responsável *
                  </label>
                  <input
                    type="text"
                    ...
                    name="nome"
                    required
                    className="w-full p-4 rounded-xl border border-slate-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 outline-none transition-all bg-slate-50"
                  />
                </div>
                <div>
                  <label htmlFor="form_empresa" className="block text-sm font-bold text-slate-700 mb-2">
                    Empresa *
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="form_email" className="block text-sm font-bold text-slate-700 mb-2">
                    E-mail Profissional *
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="form_telefone" className="block text-sm font-bold text-slate-700 mb-2">
                    Telefone / WhatsApp *
                  </label>
                  <input
                    type="tel"
              ...
              <div>
                <label htmlFor="form_servico" className="block text-sm font-bold text-slate-700 mb-2">
                ...
                <select
                  ...
                  required
                  defaultValue=""
                  className="w-full p-4 rounded-xl border border-slate-300 bg-slate-50 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 outline-none transition-all font-medium cursor-pointer"
                >
              ...
              <div>
                <label htmlFor="form_mensagem" className="block text-sm font-bold text-slate-700 mb-2">
                  Detalhes da Demanda
                </label>
                <textarea
                  id="form_mensagem"
                  name="mensagem"
                  rows="3"
                  className="w-full p-4 rounded-xl border border-slate-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 outline-none transition-all bg-slate-50 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-yellow-400 text-[#0f172a] font-extrabold py-5 rounded-xl shadow-lg hover:bg-yellow-500 transition-all flex items-center justify-center gap-3 text-lg group disabled:opacity-70 disabled:cursor-not-allowed"
              >
