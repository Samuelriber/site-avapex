        ...
        <div className="border-t border-slate-800 pt-8">
          ...
          <div className="grid md:grid-cols-3 gap-10 mb-8">
            ...
            <div className="flex flex-col gap-5">
              <div>
                <p className="text-slate-500 text-sm uppercase tracking-widest font-semibold mb-1">Central de Atendimento</p>
                <a href={WHATSAPP_TAIS} className="text-slate-300 text-base font-bold hover:text-brand-yellow transition-colors block">
                  Taís · {PHONE_TAIS}
                </a>
                <a href={WHATSAPP_JOICE} className="text-slate-300 text-base font-bold hover:text-brand-yellow transition-colors block">
                  Joice · {PHONE_JOICE}
                </a>
              </div>
              <div>
              ...
              <div>
                <p className="text-slate-500 text-sm uppercase tracking-widest font-semibold mb-1">Matriz</p>
                <p className="text-slate-300 text-base leading-relaxed">
                  Rodovia BR040, 22750, Barreira<br />Cons. Lafaiete / MG
                </p>
              </div>
              <div>
                <p className="text-slate-500 text-sm uppercase tracking-widest font-semibold mb-1">CNPJ</p>
                <p className="text-slate-300 text-base font-mono">36.407.430/0001-00</p>
              </div>
            </div>

            {/* Coluna 2: Redes Sociais */}
            <div className="flex flex-col gap-4">
              <p className="text-slate-500 text-sm uppercase tracking-widest font-semibold">Siga-nos nas Redes Sociais</p>
              <a
                href="https://www.instagram.com/avapextransportes/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram Avapex Transportes"
                className="flex items-center gap-3 text-slate-400 hover:text-brand-yellow transition-colors text-base font-medium"
              >
            ...
            <div>
              <h4 className="text-slate-300 text-sm font-bold uppercase tracking-widest mb-4">
                Área de Atuação
              </h4>
